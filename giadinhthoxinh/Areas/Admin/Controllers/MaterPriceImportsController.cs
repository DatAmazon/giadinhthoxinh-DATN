...
namespace giadinhthoxinh.Areas.Admin.Controllers
{
    public class MaterPriceImportsController : Controller
    {
        ...
        {
            ViewBag.PK_iMaterialID = new SelectList(db.tblMaterials, "PK_iMaterialID", "sMaterialName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "PK_iMaterPriceImportID,PK_iMaterialID,fMaterPriceImport,dtStartDay,dtEndDay")] tblMaterPriceImport tblMaterPriceImport)
        {
            ...
            ViewBag.PK_iMaterialID = new SelectList(db.tblMaterials, "PK_iMaterialID", "sMaterialName", tblMaterPriceImport.PK_iMaterialID);
            return View(tblMaterPriceImport);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PK_iMaterPriceImportID,PK_iMaterialID,fMaterPriceImport,dtStartDay,dtEndDay")] tblMaterPriceImport tblMaterPriceImport)
        {
            if (ModelState.IsValid)
            {
