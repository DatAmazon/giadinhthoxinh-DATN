...
namespace giadinhthoxinh.Areas.Admin.Controllers
{
    public class MaterSizesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PK_iMaterSizeID,PK_iMaterialID,sMaterSize")] tblMaterSize tblMaterSize)
        {
            ...
            ViewBag.PK_iMaterialID = new SelectList(db.tblMaterials, "PK_iMaterialID", "sMaterialName", tblMaterSize.PK_iMaterialID);
            return View(tblMaterSize);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PK_iMaterSizeID,PK_iMaterialID,sMaterSize")] tblMaterSize tblMaterSize)
        {
            if (ModelState.IsValid)
            {
